# [![](assets/img/logo-readme2.jpg)](https://devmentor.pl) &nbsp; React: Styling

Możliwości stylowania tj. definiowania wyglądu komponentów w React jest bardzo dużo - w szczególności, gdy spojrzy się na listę rozwiąząń [CSS in JS](https://github.com/MicheleBertoli/css-in-js). My skupimy się na jednym z najpopularniejszych rozwiązań jakim jest [Styled Compnents](https://styled-components.com/).

Twoim zadaniem będzie przygotować w każdym zadaniu inny komponent (lub ich zestaw) wzorując się na [React Boostrap](https://react-bootstrap.github.io/), który już został podpięty do naszej konfiguracji. Całość wystarczy uruchomić przy pomocy `npm start` jeśli tylko wcześniej zainstalowałeś wymagane zależności przez `npm i`.
